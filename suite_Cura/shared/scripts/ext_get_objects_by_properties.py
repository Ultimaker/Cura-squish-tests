...
class ext_get_objects_by_properties:
    """
    Usage:
    
     source(findFile("scripts", "ext_ext_get_objects_by_properties.py"))
     if 0: from ext_get_objects_by_properties import *

     objs = ext_ext_get_objects_by_properties.get_objects("parent_object_name", {"type": "QModelIndex", text="Ferns"}, max_find_count=1)
     mouseClick(waitForObject(objs[0]))
    """
