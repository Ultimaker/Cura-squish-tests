...
import os.path #To join paths to get the final path.
import sys #To detect the current platform.

##  Class that provides the locations where Cura stores its resources and
#   configuration files.
#
