Feature: Performance of slicing, and gcode
  ...
  Scenario: Save model to gcode and verify size
    ...
    And I select the 'Ultimaker 3' printer with Engineering intent and 'Fine - 0.1mm' profile
  ...
  Scenario Outline: Slicing objects with profile: Fine and printer: UM3
    ...
    And I select the 'Ultimaker 3' printer with Normal intent and 'Fine - 0.1mm' profile
